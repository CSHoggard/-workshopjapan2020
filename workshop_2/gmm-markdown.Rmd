...
if(!require("rio")) install.packages('RCurl', repos='http://cran.us.r-project.org')
```

To download the data into R/Rstudio we can use the `import` function from the `rio` package: 

```{r}
# read in the data from GitHub
database <- rio::import("https://github.com/benmarwick/-workshopjapan2020/raw/master/workshop_2/database.rds")

tpslines <- rio::import("https://github.com/benmarwick/-workshopjapan2020/raw/master/workshop_2/tpslines.rds")
```
...
=======
Out(tpslines$coo)
>>>>>>> 77c3c4d0ca6ddef96a4c43d0af29720201b055c7
```
